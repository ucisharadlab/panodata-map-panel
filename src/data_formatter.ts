  ...
  setTableValues(tableData, data) {
    if (tableData && tableData.length > 0) {
      ...
      tableData[0].forEach((datapoint) => {
        ...
        //Assign vertices, radius, and location shape
        const vertices = datapoint[this.settings.tableQueryOptions.verticesField];
        const radius = datapoint[this.settings.tableQueryOptions.radiusField];
        const space_shape = datapoint[this.settings.tableQueryOptions.spaceShapeField];
        ...
        const dataValue = {
          ...
          LocationVertices: vertices,
          LocationRadius: radius,
          LocationShape: space_shape,
